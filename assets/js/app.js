...
function getContent() {
    $.ajax({
        method: 'GET',
        url: 'https://me.jd09524.com/wp-json/wp/v2/pages/?parent=' + parentPageID + '&order=asc&orderby=menu_order',
        dataType: 'json',
